...
export default class FeedView extends Component {
    ...
    async uploadImage(photo) {
        ...
        fetch(path, {
            ...
            .then(response => {
                bugsnag.notify("Profile picture uploaded successfully");
        ...
        return (
            <View style={{padding: 10, backgroundColor: "#3C1364"}}>
                ...
                >
                    ...
                    >
                        <Text style={{fontSize: 13}}>{contentQuestion}</Text>
                        {contentImage != undefined && contentImage != null ? (
                            <Image
                                resizeMode={"cover"}
                        ...
                        >
                            ...
                            >
                                ...
                                <TouchableOpacity
                                    ...
                                    onPress={() => this.onPressShareButton(item)}
                    ...
                    >
                        ...
                        >
                            <View style={{flexDirection: "row"}}>
                                ...
                                >
                                    <TouchableOpacity
                                        onPress={() => this.setSharesOnPage(this.props.user.shares)}
                                        ...
                                        <Image
                                            ...
                                            source={
                                                this.props.user.profile.pictureURL
                                                    ? {uri: this.props.user.profile.pictureURL}
                        ...
                        <View style={[styles.viewTab]}>
                            ...
                            >
                                <Tab
                                    heading={I18n.t("myFeed") + " " + this.props.user.profile.firstName + " (" + this.props.user.profile.email + ")"}
                                    tabStyle={{
                                        backgroundColor: "#9601a1",
                                        borderBottomWidth: 5,
